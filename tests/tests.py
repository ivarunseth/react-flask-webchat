...
from api import create_app, db, socketio
from api.models import User
from api.tasks import async_task
...
class Tests(unittest.TestCase):
    ...
    def test_user(self):
        ...
        self.assertEqual(r['_links']['self'], url)
    ...
    def test_user_online_offline(self):
        ...
        with mock.patch('api.utils.time.time', return_value=since + 10):
    ...
    def test_message(self):
        ...
        with mock.patch('api.utils.time.time',
        ...
        with mock.patch('api.models.requests.get', side_effect=responses()):
            r, s, h = self.post(
                '/api/messages',
    ...
    def test_celery(self):
        ...
        with mock.patch('api.tasks.run_flask_request.apply_async',
        ...
        with mock.patch('api.blueprints.messages.jsonify', side_effect=ValueError):
            r, s, h = self.post(
                '/api/messages',
                data={'source': 'hello!'},
                token_auth=token)
